...
typedef struct {
  ...
  S08 id_nums_glonass[ST_MAX_GLO_NCHAN]; // ID numbers of GLONASS satellites used in solution
  S16 nsv_used_beidou2;                    // number of BEIDOU2 satellites in use
  S08 id_nums_beidou2[ST_MAX_BD2_NCHAN]; // ID numbers of BEIDOU2 satellites used in solution
  S16 nsv_used_galileo;                    // number of BEIDOU2 satellites in use
  S08 id_nums_galileo[ST_MAX_GAL_NCHAN]; // ID numbers of BEIDOU2 satellites used in solution
  ...
  // timing only
  S16 _1pps_mode;
  U32 _1pps_survey_length;
  F32 _1pps_quant_error;    //quantive error (ns)
  U32 _1pps_survey_std_dev_thr;
  U32 _1pps_cal_std_dev_after_survey;
